...
const About = () => {
  const iconClass =
    "absolute text-emerald-600 opacity-[0.15] text-2xl transition-transform duration-300 hover:scale-125";

  return (
    <div className="bg-slate-50 min-h-screen flex flex-col md:flex-row items-center justify-center md:gap-60 sm:gap-20 px-6 md:px-6 py-16 relative overflow-hidden bg-square-pattern" style={{ fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif" }}>
      {/* Left Side Content */}
      <motion.div
      ...
      >
        <h1 className="text-3xl md:text-4xl font-semibold text-emerald-900 leading-snug tracking-tight">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="bg-emerald-600 text-white shadow-md font-mono text-xs uppercase tracking-widest py-3 px-8 rounded-sm hover:bg-emerald-700 transition-colors mt-4 font-semibold"
        >
          Initialize Protocol
        </motion.button>
      </motion.div>
