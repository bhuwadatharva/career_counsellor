...
from app.router import auth_router, career_router, job_router
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://career-counsellor-2-h3c8.onrender.com", "http://localhost:5173", "https://career-counsellor-1-g01v.onrender.com"],
